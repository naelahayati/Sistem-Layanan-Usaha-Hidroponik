...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\FIELA-TEAM\ALFI\Nazfram\Nazfram\public\storage' => 'string',
            ...
            'services.midtrans.serverKey' => 'string',
            'services.midtrans.clientKey' => 'string',
            'services.midtrans.isProduction' => 'boolean',
            'services.midtrans.isSanitized' => 'boolean',
            'services.midtrans.is3ds' => 'boolean',
...
'filesystems.links.C:\\xampp\\htdocs\\FIELA-TEAM\\ALFI\\Nazfram\\Nazfram\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mail.markdown.paths','midtrans.server_key','midtrans.client_key','midtrans.is_production','midtrans.is_sanitized',
'midtrans.is_3ds','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'services.slack.notifications.channel','services.midtrans.serverKey','services.midtrans.clientKey','services.midtrans.isProduction','services.midtrans.isSanitized',
'services.midtrans.is3ds','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'signed','throttle','verified','cek_pengguna',);
        registerArgumentsSet('routes', 'login','do.login','register','do.register',
'logout','password.send-code','password.verify-code','password.reset','nazfram.home',
'nazfram.profil','nazfram.produk','nazfram.kunjungan','nazfram.pelatihan','nazfram.akun',
'nazfram.reservasi-kunjungan','reservasi.riwayat','nazfram.reservasi.store','nazfram.pembayaran_kunjungan','nazfram.pembayaran_kunjungan.konfirmasi',
'nazfram.daftar','nazfram.pelatihan.store','nazfram.store-magang','nazfram.pembayaran_magang','nazfram.pembayaran_magang.konfirmasi',
'nazfram.pelatihan.events','magang.riwayat','nazfram.beli-produk','nazfram.keranjang','nazfram.pesanan',
'nazfram.pesanan.proses','nazfram.keranjang.tambah','nazfram.keranjang.update','nazfram.keranjang.hapus','nazfram.profil-saya',
'nazfram.profil-saya.update','nazfram.profil-saya.kirim-kode','nazfram.profil-saya.verifikasi-kode','nazfram.profil-saya.ubah-password','nazfram.profil-saya.ubah-email',
'nazfram.riwayat-pesanan','nazfram.kunjungan.payment','nazfram.pembayaran.qr','nazfram.pembayaran.konfirmasi',
'nazfram.pesanan.expire','admin.dashboard','admin.laporan','admin.transaksi','admin.transaksi.get',
'admin.transaksi.update-status','admin.produk-admin','admin.produk.create','admin.produk.add','admin.produk.edit_form',
'admin.produk.edit','admin.produk.delete','admin.kunjungan-admin','admin.kunjungan.create','admin.kunjungan.add',
'admin.kunjungan.edit_form','admin.kunjungan.edit','admin.kunjungan.delete','admin.magang-admin','admin.magang.create',
'admin.magang.add','admin.magang.edit_form','admin.magang.edit','admin.magang.delete','admin.kunjungan-manajemen',
'admin.kunjungan.update-status','admin.magang-manajemen','admin.magang.update-status','admin.jadwal-admin','admin.jadwal.events',
'admin.jadwal.add','admin.jadwal.edit','admin.jadwal.delete','admin.jadwal.get','admin.daftar-user',
'admin.kelola-admin','admin.admin.create','admin.add','admin.admin.edit_form','admin.edit',
'admin.admin.kirim-kode','admin.admin.verifikasi-kode','admin.admin.ubah-email','admin.admin.ubah-password','admin.delete',
'storage.local',);
        registerArgumentsSet('views', 
'admin.Theme.defualt','admin.Theme.header','admin.Theme.sidebar','admin.daftar_user','admin.dashboard',
'admin.jadwal','admin.kelola_admin','admin.kelola_admin_form','admin.kunjungan','admin.kunjungan_form',
'admin.kunjungan_manajemen','admin.laporan_penjualan','admin.magang','admin.magang_form','admin.magang_manajemen',
'admin.produk','admin.produk_form','admin.transaksi','auth.Register','auth.login',
'beli-produk','emails.kode-verifikasi-profil','emails.reset-code','home','keranjang',
'kunjungan','master','notifications::email','pelatihan','pembayaran',
'pembayaran_kunjungan','pembayaran_magang','pendaftaran_pelatihan','pesanan','produk',
'profil','profil_pengguna','reservasi_kunjungan','riwayat','riwayat_pendaftaran',
'riwayat_pesanan','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header','vendor.mail.html.layout',
...
'vendor.mail.text.subcopy','vendor.mail.text.table','vendor.notifications.email','welcome','laravel-exceptions-renderer::components.card',
...
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid',
'C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.FIELA-TEAM.ALFI.Nazfram.Nazfram.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'VITE_APP_NAME','MIDTRANS_SERVER_KEY','MIDTRANS_CLIENT_KEY',);
