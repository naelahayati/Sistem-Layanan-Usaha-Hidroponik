    ...
    <div class="container-fluid">
        <div class="row" id="productContainer">
            ...
            <div class="col-md-3 col-sm-4 col-6 mb-4">
                <a href="{{ route('admin.produk.create') }}" style="text-decoration: none;">
                    <div class="card h-100 d-flex justify-content-center align-items-center" style="cursor:pointer; background-color: #E3F2FD; border: 2px dashed #90CAF9; min-height: 250px;">
                        <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                            ...
                            <h6 class="mt-3" style="color: #1565C0;">Tambah Produk</h6>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border-radius: 12px; overflow: hidden;">
            ...
            <div class="modal-body text-center pb-4 px-4">
                ...
                <div class="d-flex justify-content-center align-items-center bg-light rounded py-2 mb-2">
                    <span class="text-muted mr-2">Stok Tersedia:</span>
                    <h5 class="mb-0 text-info font-weight-bold" id="viewStock"></h5>
                </div>
                <div class="d-flex justify-content-center align-items-center bg-light rounded py-2">
                    <span class="text-muted mr-2">Stok di Keranjang Pengguna:</span>
                    <h5 class="mb-0 text-warning font-weight-bold" id="viewCartStock"></h5>
                </div>
                <div class="text-left bg-light rounded p-3 mt-2">
