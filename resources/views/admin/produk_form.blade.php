    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card shadow-sm" style="border-radius: 12px; border: none;">
                <div class="card-body">
                    <form
                        action="{{ isset($product) ? route('admin.produk.edit', $product->id) : route('admin.produk.add') }}"
                        method="POST" enctype="multipart/form-data" 
                        id="{{ isset($product) ? 'editProductForm' : 'addProductForm' }}">
                        @if(isset($product))
                        ...
                        <div class="row">
                                        ...
                                        @if(isset($product))
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control bg-light font-weight-bold"
                                                        value="{{ $product->stock + $product->cart_stock }}" readonly>
                                                </div>
                                                ...
                                                <input type="hidden" name="stock"
                                                    value="{{ $product->stock + $product->cart_stock }}">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                id="add_stock" name="add_stock" value="0" min="0">
                                                        </div>
                                                        <small class="text-muted text-xs">Masukkan jumlah yang ingin
                                                            ditambahkan.</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                id="reduce_stock" name="reduce_stock" value="0" min="0">
                                                        </div>
                                                        <small class="text-muted text-xs">Masukkan jumlah yang ingin
                                                            dikurangi.</small>
                                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label
                                        for="image">{{ isset($product) ? 'Ganti Gambar Produk (Kosong jika tidak ganti)' : 'Gambar Produk' }}</label>
                                    @if(isset($product) && $product->image)
                                        <div class="mb-2">
                                            <img src="{{ $product->image_url }}" class="rounded shadow-sm"
...
@push('scripts')
<script src="{{ asset('js/admin/produk_admin.js') }}"></script>
@endpush
